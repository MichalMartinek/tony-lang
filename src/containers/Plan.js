                ...
                <div>
                    ...
                    <div className="wrapper">
                        <div className="description">
                            <h1>Wow</h1>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad illo ipsam praesentium
                                tempora vitae. Aliquid dicta dolore earum eos, esse hic inventore, modi quae quaerat,
                                quasi quo rerum sed tenetur?</p>
                        </div>
                        <div className="editor">
                            <Editor handleChange={this.props.changeCode} value={this.props.value}/>
                            <div className="controls">
                                {(this.props.completed !== t.RUNNING) ?
                                    <button className="run"
                                      onClick={() => this.props.compile(this.props.value, JSON.parse(JSON.stringify(this.props.level)))}
                                    >
                                        Run ▶
                                    </button> : <button className="run warn" onClick={this.props.stop}>
                                        Stop ■
                                    </button>
                                }
                                <button className="run warn" onClick={this.initBoard}
                                        disabled={this.props.completed === t.RUNNING}>Reset
                                </button>
